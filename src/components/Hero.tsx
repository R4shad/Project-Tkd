...
export const Hero: React.FC<HeroProps> = ({ image, title, description }) => {
  return (
    <section
      className="hero py-12 relative bg-[url('/src/assets/svg.png')] bg-cover bg-center"
    >
      <div className="container mx-auto flex pb-48 flex-col-reverse md:flex-row items-center justify-between px-6">
        ...
        <div className="md:w-sm flex justify-center pb-10 w-2xs">
          <img src={image} alt="Hero" className="w-full max-w-md rounded-lg shadow-lg" />
        </div>
      </div>
    </section>
  );
