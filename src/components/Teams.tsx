...
const listTeams: CardProps[] = [
  {
    image:
      'https://res.cloudinary.com/ddkjviwgt/image/upload/v1745272836/f2_a2jsix.jpg',
  ...
  {
    image:
      'https://res.cloudinary.com/ddkjviwgt/image/upload/v1745272356/f4_z9ykqa.jpg',
  ...
  {
    image:
      'https://res.cloudinary.com/ddkjviwgt/image/upload/v1745273082/f2_iy5tid.jpg',
