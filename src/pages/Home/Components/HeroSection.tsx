...
export const HeroSection: React.FC<HeroProps> = ({
  ...
  return (
    <section className="hero py-12 relative bg-[url('/src/assets/svg.png')] bg-cover bg-center min-h-[1300px] sm:min-h-[900px] md:min-h-[700px]">
      <div
        className="container mx-auto flex pb-48 flex-col-reverse md:flex-row items-center justify-between px-6"
        data-aos="fade-up"
      ...
      >
        <div className="hero__container md:w-1/2 text-center md:text-left space-y-6">
          ...
          <div className="flex justify-center md:justify-start space-x-4  ">
            ...
            <button
              className="border border-custom-border text-white px-6 py-2 rounded-lg shadow-md  transform transition duration-300 hover:scale-105 hover:shadow-2xl hover:bg-black hover:text-white hover:border-black"
