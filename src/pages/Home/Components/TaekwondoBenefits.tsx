...
export const BenefitsSection = () => {
  return (
    <>
      <div className=" bg-custom-primary-color  pb-6 pt-10"  data-aos="fade-up" data-aos-duration="2000">
        <h2 className="text-center text-white pt-6 pb-6 text-3xl md:text-4xl">
